            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Apiary Creation</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-lg-4">
                   <form action = "addapiary" method = "post">
                       @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-control-label" for="input-name">{{ __('Number of Hives') }}</label>
                                    <input type="text" name="nbrhives" id="input-name"  class="type form-control ">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-control-label" for="input-name">{{ __('Status') }}</label>
                                    <input type="text" name="status" id="input-name"  class="type form-control ">
                                </div>
                            </div>
