                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="text-white mb-0">Int Temperature Measurement</h2>
                            </div>
                            <div class="col">
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-light ls-1 mb-1">Overview</h6>
                                <h2 class="text-white mb-0">Ext Temperature Measurement</h2>
                            </div>
                            <div class="col">
                                <ul class="nav nav-pills justify-content-end">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('user.index') }}" class="btn btn-sm btn-orange">See all</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('tasks')}}" class="btn btn-sm btn-orange">See all</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
